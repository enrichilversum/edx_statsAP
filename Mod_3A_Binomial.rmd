...
The function used is `pbinom`, without any extra argument it calculate the cumulative binomial distribution for $P(X>x)$, for cumulative probabilities of $P(X\leqx)$ the argument to be used is `lower.tail=FALSE`. 
